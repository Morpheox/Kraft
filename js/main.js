...
var rew=0;
if(enemytipo<25){
enemy["peasant"]=Math.round(Math.random()*power*0.25)+(power*0.3)+1;
...
enemy["bandit"]=Math.round(Math.random()*power*0.15)+(power*0.12)+1;
...
enemy["mercenary"]=Math.round(Math.random()*power*0.07)+(power*0.06)+1;
stringencuentro+=enemy["mercenary"]+" Mercenarys (Attack:9 Hp:40)<br>";
rew+=(Math.random()*enemy["mercenary"]*0.15)+(enemy["mercenary"]*0.11)
}
if(enemytipo>110){
enemy["soldier"]=Math.round(Math.random()*power*0.04)+(power*0.035)+1;
